...
An iOS app that makes files on a UniFi NAS (UNAS/UNAS Pro) searchable via
Siri/Spotlight and editable in native apps (Numbers, Word, etc.), without
relying on the Files app's limited SMB support.
