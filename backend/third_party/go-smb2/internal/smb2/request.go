...
//
// Upstream go-smb2 only defines the SMB2_CHANGE_NOTIFY command opcode, not
// this packet — the wire format below follows MS-SMB2 2.2.35, mirroring
// QueryDirectoryRequest's layout/encode pattern above.
